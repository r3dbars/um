...
- **No transcript store.** Partial text is scanned for the tracked word list and discarded. Um does not write recordings or transcripts to disk. Diagnostic logs do not include transcript text.
